...
class Rasterizer
{
    ...
    void drawBottomTriangleTexture(math::vertex &v1, math::vertex &v2, math::vertex &v3, Texture *texture);
    void drawTopTriangleTexture(math::vertex &v1, math::vertex &v2, math::vertex &v3, Texture *texture);
